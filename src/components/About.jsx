...
const About = ({ text }) => {
  return (
    <>
      <div className="justify-center flex-1 max-w-6xl py-4 lg:py-6 md:px-6 m-[10rem] mt-[15rem]">
        <div className="flex flex-wrap items-center ">
          <div className="w-full mb-10 lg:w-1/2 lg:mb-0 px-4 ">
            <div className="lg:max-w-md">
              <span className="topic-class text-teal-400 uppercase">
                About Us
              </span>
              <h2 className="mt-4 mb-6 text-2xl font-bold text-white">
              ...
              <p className="mb-10 text-gray-600 dark:text-gray-400">
                ...
                ipaino amet Lorem ipsum dor amet is a dummy text
              </p>
            </div>
          </div>
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="flex mb-4">
              ...
              <div>
                <h2 className="mb-4 text-xl font-bold leading-tight  text-white md:text-2xl">Design</h2>
            ...
            <div className="flex mb-4">
              ...
              <div>
                <h2 className="mb-4 text-xl font-bold leading-tight  text-white md:text-2xl">Strategy</h2>
                <p className="text-base leading-loose text-gray-500 dark:text-gray-400">
                  Lorem ipsum dor amet Lorem ipsum dor amet is a dummy text .Lorem ipsum dor amet isopinus
                  ipaino
                </p>
            ...
            <div className="flex mb-4">
              ...
              <div>
                <h2 className="mb-4 text-xl font-bold leading-tight text-white md:text-2xl">Develop</h2>
                <p className="text-base leading-loose text-gray-500 dark:text-gray-400">
                  Lorem ipsum dor amet Lorem ipsum dor amet is a dummy text .Lorem ipsum dor amet isopinus
                  ipaino
                </p>
